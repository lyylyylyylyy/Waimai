    ...
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        <div class="rating-type border-1px">
          <span class="block positive" :class="{active: selectType===2}" @click="setSelectType(2)">全部<span class="count">{{ratings.length}}</span></span>
          <span class="block positive" :class="{active: selectType===0}"
                @click="setSelectType(0)">满意<span class="count">{{positiveCount}}</span>
          </span>
    ...
    filterRatings () {
      ...
      return ratings.filter(rating => {
        ...
        /*
                    ...
                    */
        /*
                    selectType: 0/1/2 如果是0/1 需要判断是否与rating.rateType 相等, 如果是2 就不
                    需要
                    onlyContent: true/false 如果为true 需要判断rating.text 必须有值, 如果是false
                    就不需要
                    */
        if (selectType === 2) {
